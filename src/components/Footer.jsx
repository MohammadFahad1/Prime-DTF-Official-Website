...
const Footer = () => {
  return (
    <>
      ...
      <div className="footer sm:footer-horizontal bg-[#171717] text-white  flex md:flex-row flex-col justify-between items-center gap-3 p-4">
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end text-white">
          ...
          <Link href={"https://www.facebook.com/primedtfbd"} target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
