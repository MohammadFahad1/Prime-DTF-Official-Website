      ...
      <div className="relative flex items-center justify-center min-h-screen text-neutral-content text-center z-20 p-4">
        <div className="bg-transparent p-4 rounded-xl md:my-16">
          ...
          <div className="flex md:flex-row flex-col items-center justify-center gap-2">
            ...
            <button className="uppercase cursor-pointer font-bold flex items-center gap-1 shadow-lg hover:shadow-xl transition-shadow bg-purple-400 text-black hover:text-white px-4 py-3 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
